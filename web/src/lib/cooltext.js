...
export const STRINGS = {
  en: {
    ...
    reportQ: 'Something wrong?',
    rClosed: 'It was closed',
    rHours: 'Hours are wrong',
    rLoc: 'Wrong location',
    rGood: '👍 It was good',
    thanksR: 'Noted — thank you.',
    fixOsm: 'Wrong? Fix it on OpenStreetMap',
  ...
  fr: {
    ...
    reportQ: 'Un problème ?',
    rClosed: 'C’était fermé',
    rHours: 'Horaires inexacts',
    rLoc: 'Mauvais emplacement',
    rGood: '👍 C’était bien',
    thanksR: 'Noté — merci.',
    fixOsm: 'Erreur ? Corrigez sur OpenStreetMap',
  ...
  es: {
    ...
    reportQ: '¿Algo mal?',
    rClosed: 'Estaba cerrado',
    rHours: 'Horario incorrecto',
    rLoc: 'Ubicación incorrecta',
    rGood: '👍 Estaba bien',
    thanksR: 'Anotado — gracias.',
    fixOsm: '¿Error? Corrígelo en OpenStreetMap',
  ...
  ca: {
    ...
    reportQ: 'Algun problema?',
    rClosed: 'Estava tancat',
    rHours: 'Horari incorrecte',
    rLoc: 'Ubicació incorrecta',
    rGood: '👍 Estava bé',
    thanksR: 'Anotat — gràcies.',
    fixOsm: 'Error? Corregeix-ho a OpenStreetMap',
  ...
  de: {
    ...
    reportQ: 'Stimmt etwas nicht?',
    rClosed: 'War geschlossen',
    rHours: 'Zeiten falsch',
    rLoc: 'Falscher Ort',
    rGood: '👍 War gut',
    thanksR: 'Notiert — danke.',
    fixOsm: 'Fehler? Auf OpenStreetMap korrigieren',
